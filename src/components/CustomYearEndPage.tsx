...
export interface CustomYearEndPageProps {
  // Basic info
  title: string;
  subtitle: string;
  description: string;
...
const CustomYearEndPage: React.FC<CustomYearEndPageProps> = ({
  title,
  subtitle,
  description,
  mainIcon: MainIcon,
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      {/* Additional Content for Key Benefits Explained and What's Included in Detail */}
...
export default CustomYearEndPage;
